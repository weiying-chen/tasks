...
class LatestTaskViewTests(unittest.TestCase):
    ...
    def test_only_one_empty_line_before_actions(self):
        ...
        actions_idx = lines.index(
            "Actions: create task | set assignee | add subtasks | add notes | confirm deadline | toggle view notes | copy message | quit"
        )
    ...
    def test_actions_highlight_expected_shortcuts(self):
        ...
        self.assertRegex(out, r"\x1b\[35mconfirm \x1b\[0m\x1b\[32md\x1b\[0m\x1b\[35meadline")
